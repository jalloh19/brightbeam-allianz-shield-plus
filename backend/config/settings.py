"""
Django settings for Brightbeam Allianz Shield Plus project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'brightbeam_allianz'),
...
LANGUAGE_CODE = 'en-us'
TIME_ZONE = os.getenv('TIMEZONE', 'Asia/Kuala_Lumpur')
USE_I18N = True
USE_TZ = True
...
# Serve static files directly from Django/Gunicorn in production.
STORAGES = {
    'default': {
...
if not DEBUG:
    # Trust HTTPS termination at proxy/load balancer (e.g., Railway).
    # Without this, Django can mis-detect secure requests and loop on 301 redirects.
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@brightbeam.com')
